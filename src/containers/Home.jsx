      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
        <div className="w-full h-full flex flex-col items-center lg:items-start justify-center gap-4">
          ...
          <p className="text-base text-texlight mt-6 text-center lg:text-left">
            a dedicated game developer with over 5 years of experience. My
            journey spans from conceptualizing intricate game mechanics to
            bringing immersive experiences to life, with a particular passion
            for Roblox games. I believe in crafting games that captivate,
            engage, and provide players with memorable moments. Outside of
            coding, I'm deeply involved in gathering player feedback and
            immersing myself in gaming communities to ensure my creations
            resonate. Let's collaborate and shape the future of gaming together!
          </p>
